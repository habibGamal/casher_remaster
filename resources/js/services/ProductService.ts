...
export default class ProductService {
    ...
    private formSettings?: ProductFormSettings;

    public setFormSettings(formSettings: ProductFormSettings) {
    ...
    private tablePaginateSettings?: ProductTablePaginateSettings;

    public setTablePaginateSettings(
        tablePaginateSettings: ProductTablePaginateSettings
    ) {
...
export class ProductFormSettings {
    constructor(
...
export class ProductTablePaginateSettings {
    constructor(
        public page: number,
